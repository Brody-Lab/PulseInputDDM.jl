...

{
    ...
    "category": "section",
    "text": "If you want to fit the model to some data but want to interact with Julia, I recommend using a Jupyter notebook and scotty. This is somewhat involved to set up but worth the time. Here are the necessary steps."
},
