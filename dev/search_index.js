...

{
    ...
    "category": "section",
    "text": "Once, Julia is installed, you can launch it by typing >> julia. From here, you need to add the IJulia package so you can use Julia in a notebook. This is done in the normal way,    julia > using Pkg\n    julia > Pkg.add(\"IJulia\")You might now want to add any packages you use, again in the normal way (for example, you can now add the pulseinputDDM package, as we will do eventually, described in the Getting the pulse input DDM package from GitHub section). You\'re done (with this part)! You can exit Julia."
},
