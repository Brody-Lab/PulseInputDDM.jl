...
pz, py, binned_clicks, spikes,λ0 = default_parameters_and_data("sig", 2, [100,200], [2,3])
@test round(compute_LL(pz["generative"], py["generative"], binned_clicks, spikes,λ0, "sig", 53), digits=2) ≈ -21343.94
