...
function filt_bound_model_wrapper{TT}(p_opt::Vector{TT},p_const::Vector{Float64}, fit_vec::BitArray{1},
        ...
        map_str::String = "exp", dt::Float64=1e-3, noise::String="Poisson")
...
function filt_bound_model{TT}(pz::Vector{TT},
        ...
        dt::Float64=1e-3,map_str::String="exp",noise::String="Poisson")
...
function ΔLR_ll_wrapper{TT}(p::Vector{TT},
...
add_prior{TT}(p::Vector{TT},mu0::Vector{Float64},beta::Vector{Float64}) = sum(map((b,p,mu0) -> b*(p - mu0)^2,beta,p,mu0))
    
function LL_func{TT}(λ::Vector{TT}, k::Union{Vector{Int},Vector{Float64}}; map_str::String = "exp", dt::Float64=1e-3, 
        noise::String="Poisson",std0::Float64=1e-1)
