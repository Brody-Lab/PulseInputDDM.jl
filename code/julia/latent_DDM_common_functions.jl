...
inv_gather{TT}(p::Vector{TT},fit_vec::Union{BitArray{1},Vector{Bool}}) = p[fit_vec],p[.!fit_vec]

function gather{TT}(p_opt::Vector{TT}, p_const::Vector{Float64}, fit_vec::Union{BitArray{1},Vector{Bool}})
...
function P_M_xc{TT}(pz::Vector{TT}, n::Int, dt::Float64)
...
function transition_Pa!{TT}(P::Vector{TT},F::Array{TT,2},pz::Vector{TT},t::Int,hereL::Vector{Int}, hereR::Vector{Int},
        La::Vector{TT},Ra::Vector{TT},M::Array{TT,2},
        dx::TT,xc::Vector{TT},n::Int,dt::Float64;backwards::Bool=false)
...
function P0{TT}(vari::TT,n::Int,dx::TT,xc::Vector{TT},dt::Float64)
...
function M!{TT}(F::Array{TT,2},vara::TT,lambda::TT,h::Union{TT,Float64},dx::TT,xc::Vector{TT}, n::Int, dt::Float64)
...
function newM!{TT}(F::Array{TT,2},vara::TT,lambda::TT,h::Union{TT,Float64},dx::TT,xc::Vector{TT}; n::Int=203, dt::Float64=2e-2)
...
function make_adapted_clicks{TT}(pz::Vector{TT}, L::Vector{Float64}, R::Vector{Float64})
