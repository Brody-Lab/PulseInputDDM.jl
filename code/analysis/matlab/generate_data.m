function [data,xgen] = generate_data(ratname,use,sessid,in_pth,xgen,more_tri_flag,num_tri,dt)
...
for i = 1:numel(sessid)
    ...
    %process rawdata
    [data] = package_data(rawdata,use,data,[],dt);
end
...
for i = 1:numel(sessid)
    ...
    [rawdata] = sample_model(rawdata,xgen2,use);
    %process rawdata
    [data] = package_data(rawdata,use,data,[],dt);
...
if more_tri_flag
    ...
    while numel(data) < num_tri
        ...
        [rawdata] = sample_model(rawdata,xgen2,use);
        %process rawdata
        [data] = package_data(rawdata,use,data,N0,dt);
