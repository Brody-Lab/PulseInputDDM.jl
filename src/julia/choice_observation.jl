...
function ll_wrapper(p_opt::Vector{TT}, p_const::Vector{Float64}, fit_vec::Union{BitArray{1},Vector{Bool}}, 
        data::Dict, n::Int, dt::Float64; map_str::String="exp") where {TT}
...
breakup(p::Vector{TT}) where {TT} = p[1:dimz],p[dimz+1]
inv_breakup(pz::Vector{TT},bias::TT) where {TT} = cat(1,pz,bias)
