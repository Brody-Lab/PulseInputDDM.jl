...
export jointDDM, jointdata, θjoint, joint_options, θh, trialsequence, trialshifted, specify_jointmodel, optimize_jointmodel, load_joint_data, load_trial_sequence
