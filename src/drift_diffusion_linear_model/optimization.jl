...
"""
function loglikelihood(θ::θDDLM, trialset::trialsetdata, latentspec::latentspecification, options::DDLMoptions, abar::Vector{Vector{T1}}, F::Vector{Matrix{T1}}, P::Vector{Matrix{T1}}, F::Vector{Matrix{T1}}) where{T1<:Real}
