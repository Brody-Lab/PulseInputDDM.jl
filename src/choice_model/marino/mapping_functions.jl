...
function map_split_combine_marino(p_opt, p_const, fit_vec, dt,
    ...
    pz, pd, pw = split_latent_and_observation_marino(combine_variable_and_const(p_opt, p_const, fit_vec))
...
split_latent_and_observation_marino(p::Vector{TT}) where {TT} = p[1:dimz], p[dimz+1:dimz+2], p[dimz+3:end]
