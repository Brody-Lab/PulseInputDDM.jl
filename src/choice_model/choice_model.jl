...
function create_options_and_x0(; modeltype = "bing")
     ...
     paramlims = Dict( 
      #:paramname => [lb, ub, fit_bing, fit_hist_initpt, hist_initpt_lapse, hist_lapse,  nofit_default]
        ...
        :lapse_prob =>  [0., 1., false, true, true, true, eps()],                  
        :lapse_bias =>  [-10., 10., false, true, true, true, 0.], 
        :lapse_modbeta=>[-50., 50., false, false, false, true, 0.],                                 
        :h_ηcL =>       [-5., 5., true, true, true, true, 0.], 
        :h_ηcR =>       [-5., 5., true, true, true, true, 0.], 
        :h_ηe =>        [-5., 5., true, true, true, true, 0.], 
        :h_βc =>        [0., 1., true, true, true, true, 0.], 
        :h_βe =>        [0., 1., true, true, true, true, 0.],
