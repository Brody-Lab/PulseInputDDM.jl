...
function optimize_model_unc(pz::Dict{}, pd::Dict{}, data; n=53,
        x_tol::Float64=1e-4, f_tol::Float64=1e-9, g_tol::Float64=1e-2,
        iterations::Int=Int(2e3), show_trace::Bool=true)
...
function compute_Hessian_unc(pz, pd, data; n::Int=53) where {TT <: Any}
...
function compute_H_CI_unc!(pz, pd, data; n::Int=53)

    H = compute_Hessian_unc(pz, pd, data; n=n)
